...
var HEADER_COMMENT     = process.env.OPIX_HEADER_COMMENT || '// WoBiNiQiang Pixel v1.0.0 | Published By wobiniqiang.com | Created By Stuart Yamartino | MIT License\n';
...
var PIXEL_FUNC_NAME    = process.env.OPIX_PIXEL_FUNC_NAME || 'wbnq';

// The remote URL of the pixel.gif file that will be pinged by the browser to send tracking information
var PIXEL_ENDPOINT     = process.env.OPIX_PIXEL_ENDPOINT || '/image/1.gif';

// The core openpixel.min.js file that the snippet will loaded asynchronously into the browser
var JS_ENDPOINT        = process.env.OPIX_JS_ENDPOINT || 'https://cdn.jsdelivr.net/gh/wobiniqiang/static-resources@1.6/js/wbnq.js';
